...
namespace WpfApp1
{
    internal class ViewOplatasVM
    { 
        class ViewOplatasVM : BaseVM
    {
        ...
        public int SelectedIndex
        {
            ...
            {
                selectedIndex = value;
                Oplatas = SqlModel.GetInstance().SelectOplatasRange((selectedIndex - 1) * ViewRowsCount, ViewRowsCount);
                Signal();
            }
        }
