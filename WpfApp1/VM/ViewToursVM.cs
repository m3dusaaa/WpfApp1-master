...
namespace WpfApp1
{
    internal class ViewToursVM
    {
        class ViewToursVM : BaseVM
        {
            ...
            public int SelectedIndex
            {
                ...
                {
                    selectedIndex = value;
                    Tours = SqlModel.GetInstance().SelectToursRange((selectedIndex - 1) * ViewRowsCount, ViewRowsCount);
                    Signal();
                }
            }
            ...
            private void InitPages()
            {
                ...
                int pageCount = (sqlModel.GetNumRows(typeof(Tour)) / ViewRowsCount) + 1;
